  ...
  try {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS sites (
        ...
        ns1 VARCHAR(255) DEFAULT 'ns1.cloudwire.onrender.com',
        ns2 VARCHAR(255) DEFAULT 'ns2.cloudwire.onrender.com',
...
const handleInMemoryQuery = async (text, params) => {
  ...
  if (lowerText.includes('insert into sites')) {
    ...
    const site = {
      ...
      ns1: ns1 || 'ns1.cloudwire.onrender.com',
      ns2: ns2 || 'ns2.cloudwire.onrender.com',
      ns3: 'ns3.cloudwire.onrender.com',
      ns4: 'ns4.cloudwire.onrender.com',
