...
function mapSiteRow(site) {
  ...
  try {
    ...
    return {
      ...
      ns1: live.ns1 || 'ns1.cloudwire.cfd',
      ns2: live.ns2 || 'ns2.cloudwire.cfd',
      ns3: live.ns3 || 'ns3.cloudwire.cfd',
      ns4: live.ns4 || 'ns4.cloudwire.cfd',
    ...
    return {
      ...
      ns1: site.ns1 || 'ns1.cloudwire.cfd',
      ns2: site.ns2 || 'ns2.cloudwire.cfd',
      ns3: site.ns3 || 'ns3.cloudwire.cfd',
      ns4: site.ns4 || 'ns4.cloudwire.cfd',
